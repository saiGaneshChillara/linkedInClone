...
const ExperienceSection = ({ isOwnProfile, userData, onSave }) => {
    ...
    const handleDeleteExperience = (id) => {
        setExperiences((prevExperineces) => prevExperineces.filter((exp) => exp._id !== id));
    };
        ...
        <div className="bg-white shadow rounded-lg p-6 mb-6">
            ...
            {experiences.map((exp) => (
                <div key={exp._id} className="mb-4 flex justify-between items-start">
                    ...
                    {isEditing && (
                        <button onClick={() => handleDeleteExperience(exp._id)} className="text-red">
                            <X size={20} />
                        </button>
                    )}
                </div>
