    ...
    return (
        <div className="bg-secondary rounded-lg shadow mb-4 p-4">
            <div className="flex space-x-3">
                <img src={user.profilePicture || "/avatar.png"} alt={user.name} className='w-12 h-12 rounded-full mx-auto object-cover' />
                <textarea 
            ...
            {imagePreview && (
                <div className="mt-4">
                    <img src={imagePreview} alt="Post Image" className='w-full h-auto rounded-lg' />
                </div>
            )}
